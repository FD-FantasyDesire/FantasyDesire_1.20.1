...
@OnlyIn(Dist.CLIENT)
public class FDSlashEffectRender<T extends EntityFDSlashEffect> extends EntityRenderer<T> {
    ...
    public FDSlashEffectRender(EntityRendererProvider.Context context) {
        super(context);
    }
