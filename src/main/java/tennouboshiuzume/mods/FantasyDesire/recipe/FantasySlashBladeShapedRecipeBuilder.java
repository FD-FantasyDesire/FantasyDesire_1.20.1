...
public class FantasySlashBladeShapedRecipeBuilder extends CraftingRecipeBuilder implements RecipeBuilder {
    ...
    public static FantasySlashBladeShapedRecipeBuilder shaped(ResourceLocation blade) {
        return shaped(() -> ForgeRegistries.ITEMS.getValue(FANTASY_SLASHBLADE), 1).blade(blade);
    }

    public static FantasySlashBladeShapedRecipeBuilder shaped(ItemLike result) {
        return shaped(result, 1);
    }

    public static FantasySlashBladeShapedRecipeBuilder shaped(ItemLike result, int count) {
        return new FantasySlashBladeShapedRecipeBuilder(result, count);
    }

    public FantasySlashBladeShapedRecipeBuilder define(Character key, TagKey<Item> tag) {
        return this.define(key, Ingredient.of(tag));
    }

    public FantasySlashBladeShapedRecipeBuilder define(Character key, ItemLike tag) {
        return this.define(key, Ingredient.of(tag));
    }

    public FantasySlashBladeShapedRecipeBuilder blade(ResourceLocation blade) {
        this.blade = blade;
        return this;
    }

    public FantasySlashBladeShapedRecipeBuilder define(Character key, Ingredient ingredient) {
    ...
    public FantasySlashBladeShapedRecipeBuilder pattern(String pattern) {
    ...
    @Override
    public @NotNull FantasySlashBladeShapedRecipeBuilder group(@Nullable String group) {
        this.group = group;
        return this;
    }

    public FantasySlashBladeShapedRecipeBuilder showNotification(boolean show) {
    ...
    public void save(Consumer<FinishedRecipe> consumer, @NotNull ResourceLocation id) {
        ...
        consumer.accept(new FantasySlashBladeShapedRecipeBuilder.Result(id, this.result, this.count, this.blade,
    ...
    public static class Result extends CraftingRecipeBuilder.CraftingResult {
        ...
        public @NotNull RecipeSerializer<?> getType() {
            return FantasySlashBladeShapedRecipe.SERIALIZER;
        }
